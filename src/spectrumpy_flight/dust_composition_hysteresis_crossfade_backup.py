...
RETURN_STABLE_SAMPLES = 12
SWITCH_RAIL_FRACTION = 0.90
RETURN_RAIL_FRACTION = 0.88
...
def _baseline_window_mask(
    ...
    *,
    ...
    """Return a mask covering the initial baseline/noise window."""
...
def _baseline_noise_stats(
    ...
    *,
    ...
    """Return robust baseline and noise sigma from the initial waveform samples."""
...
def _first_microsecond_mean(values: Optional[np.ndarray], times: Optional[np.ndarray]) -> float:
    """Return the first-microsecond median baseline for compatibility."""
...
class DustCompositionWindow(QMainWindow):
    ...
    def __init__(
        ...
        *,
        ...
        self._scale_tof_gains = bool(scale_tof_gains)
    ...
    def _combine_waveforms(self) -> Optional[np.ndarray]:
        return combine_waveform_channels(
            ...
            scale_to_gain=self._scale_tof_gains,
        )
...
def launch_dust_composition_window(
    ...
    *,
    ...
    return DustCompositionWindow(
        ...
        read_only=read_only,
        scale_tof_gains=scale_tof_gains,
        parent=parent,
    )
